...
import { AccessSubProducts2 } from './AccessSubProducts2';

const AccessProducts2 = () => {
	...
	const fetchData = () => {
		const product = cars.find((item) => item._id == productid);
		if (product) {
		...
		<>
			<div className='pt-10 transition-opacity ease-in duration-500 container mx-auto px-4 sm:px-6 lg:px-8'>
				...
				<div className='flex flex-col lg:flex-row gap-8'>
					...
					<div className='w-full lg:w-1/3 border border-gray-300 rounded-xl p-4 sm:p-6 flex flex-col h-[300px] gap-4'>
				...
				<AccessSubProducts2 category={productData.category} />
			</div>
...
export default AccessProducts2;
