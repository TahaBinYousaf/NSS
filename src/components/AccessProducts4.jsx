...
import { AccessSubProducts4 } from './AccessSubProducts4';

const AccessProducts4 = () => {
	...
	const fetchData = () => {
		const product = services.find((item) => item._id == productid);
		if (product) {
	...
	return productData ? (
		<>
			<div className='pt-10 transition-opacity ease-in duration-500 container mx-auto px-4 sm:px-6 lg:px-8'>
				...
				<AccessSubProducts4 category={productData.category} />
			</div>
...
export default AccessProducts4;
