...
import { LatestCollection6Items } from '../components/LatestCollection6Items';
	...
	return (
		<div className='flex flex-col sm:flex-row gap-1 sm:gap-10 py-10'>
			...
			<div className='flex-1'>
				...
				<div className='mt-[80px] sm:mt-8 mb-5 flex flex-col gap-4 px-4 sm:px-0'>
					{filterProducts.map((item, index) => (
						<div
							data-aos='fade-right'
							key={index}
							className='w-full pb-2 bg-white rounded-lg'>
